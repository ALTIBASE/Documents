...
extern "C" char\* str_uppercase_return( char\* str1, long long str1_len, char\*
str2 );
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
void entryfunction(char\* func_name, int arg_count, void \*\* args, void \*\*
returnArg)
...
\*\*(int\*\*)returnArg = str_uppercase_count ((char\*)args[0], \*((long
long\*)args[1]), (char\*)args[2]);
...
\*(char\*\*)returnArg = str_uppercase_return ((char\*)args[0], \*((long
long\*)args[1]), (char\*)args[2]);
