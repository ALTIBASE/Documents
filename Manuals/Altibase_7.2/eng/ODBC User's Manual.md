...
When you need immediate assistance regarding technical issues, please contact [Altibase's Support Portal](http://support.altibase.com/en/).
...
If the user executes the exe file generated after compiling in Visual C++, the following result will be dispalyed.
