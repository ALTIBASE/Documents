...
Altibase는 이중화 관리를 위한 GUI 도구로 Replication Manager를 제공하며, 이중화 중에 발생한 데이터 불일치를 확인하고 보정할 수 있는 altiComp 유틸리티도 제공한다. 자세한 설명은 [***Replication Manager User's Manual***](https://github.com/ALTIBASE/Documents/blob/7.3branch/Manuals/Tools/Altibase_release/kor/Replication%20Manager%20User's%20Manual.md) 과 *[**Utilities Manual**의 altiComp](https://github.com/ALTIBASE/Documents/blob/master/Manuals/Altibase_7.3/kor/Utilities%20Manual.md#2alticomp)*를 참조한다.
