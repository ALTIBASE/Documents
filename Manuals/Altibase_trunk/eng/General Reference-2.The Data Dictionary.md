...
This is the name of an Altibase module. At present, Altibase consists of theCM, DK, JOB, LB, MM, QP, RP, RP_CONFLICT, SERVER, SM, SNMP, and ST modules, each of which can perform message logging.
...
Altibase provides 12 messages logging properties such as the CM, DK, JOB, LB, MM, QP, RP, RP_CONFLICT, SERVER, SM, SNMP, and ST as follows.
