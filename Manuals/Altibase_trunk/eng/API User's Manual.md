...
- Default Value : N/A
- Range :  [Supported Database Character Sets](https://github.com/ALTIBASE/Documents/blob/master/Manuals/Altibase_trunk/eng/Getting%20Started%20Guide.md#supported-database-character-sets)
- Mandatory : No
- Setting Range : Session
...
The number of created connections cannot exceed the Altibase server property [MAX_CLIENT](https://github.com/ALTIBASE/Documents/blob/master/Manuals/Altibase_trunk/eng/General%20Reference-1.Data%20Types%20%26%20Altibase%20Properties.md#max_client), so when configuring the `max pool size` and `min pool size` properties, MAX_CLIENT should be taken into account.
...
- [Altibase trunk Administrator's Manual - 5.Objects and Privileges](https://github.com/ALTIBASE/Documents/blob/master/Manuals/Altibase_trunk/eng/Administrator%E2%80%99s%20Manual.md#5-objects-and-privileges)
- [Altibase trunk General Reference-2.The Data Dictionary](https://github.com/ALTIBASE/Documents/blob/master/Manuals/Altibase_trunk/eng/General%20Reference-2.The%20Data%20Dictionary.md)
