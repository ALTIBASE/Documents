...
기본값 ANY는 지역 서버의 모든 IP 주소가 이중화 통신에 사용될 수 있으며 ANY가 아닌 특정 IP를 설정하면 다중 IP 네트워크 환경이더라도 설정한 IP 주소만 이중화 통신에 사용된다.<br/>
이 설정은 이중화 통신 방법 TCP, Inifiband 중 TCP만 적용된다.<br/>
