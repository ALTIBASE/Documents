...
-   OTHER DB : JDBC v4.2 이하 버전을 지원하는 데이터베이스 중 Altibase와 동일한 DML 구문을 사용하는 데이터베이스
...
jdbcAdapter 7.4는 JRE 8 이상 버전에서 동작하는 응용 프로그램이므로, jdbcAdapter가 운영될 장비에 8 이상 버전의 JRE가 설치되어 있어야 한다.
