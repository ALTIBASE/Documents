...
IF NOT EXISTS 절을 명시하면 같은 이름의 저장 프로시저가 존재하지 않는 경우에만 생성한다. 같은 이름의 저장 프로시저가 존재하는 경우, CREATE 문은 오류 없이 실행되지만 기존의 저장 프로시저는 아무 영향을 받지 않는다.
...
IF NOT EXISTS 절을 명시하면 같은 이름의 저장 함수가 존재하지 않는 경우에만 생성한다. 같은 이름의 저장 함수가 존재하는 경우, CREATE 문은 오류 없이 실행되지만 기존의 저장 함수는 아무 영향을 받지 않는다.
...
IF NOT EXISTS 절을 명시하면 같은 이름의 타입 세트가 존재하지 않는 경우에만 생성한다. 같은 이름의 타입 세트가 존재하는 경우, CREATE 문은 오류 없이 실행되지만 기존의 타입 세트는 아무 영향을 받지 않는다.
...
IF NOT EXISTS 절을 명시하면 같은 이름의 패키지가 존재하지 않는 경우에만 생성한다. 같은 이름의 패키지가 존재하는 경우, CREATE 문은 오류 없이 실행되지만 기존의 패키지는 아무 영향을 받지 않는다.
...
IF NOT EXISTS 절을 명시하면 같은 이름의 패키지 바디가 존재하지 않는 경우에만 생성한다. 같은 이름의 패키지 바디가 존재하는 경우, CREATE 문은 오류 없이 실행되지만 기존의 패키지 바디는 아무 영향을 받지 않는다.
