...
| 카테고리                 | 프로퍼티 이름                        |  기본값   | 설명                                                         |
| ------------------------ | :----------------------------------- | :-------: | :----------------------------------------------------------- |
| 쿠버네티스 설정 프로퍼티 | AKU_STS_NAME                         |           | 쿠버네티스 오브젝트 명세에 정의한 스테이트풀셋 이름.<br>설정할 수 있는 이름의 최대 글자 수는 63자이다. |
|                          | AKU_SVC_NAME                         |           | 쿠버네티스 오브젝트 명세에 정의한 네트워크 서비스를 제공하는 서비스 이름.<br/>설정할 수 있는 이름의 최대 글자 수는 63자이다. |
