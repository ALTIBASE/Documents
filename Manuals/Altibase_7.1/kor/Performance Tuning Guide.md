...
- [1.성능 튜닝 소개](#1성능-튜닝-소개)
  - [성능 튜닝 개요](#성능-튜닝-개요)
  - [데이터베이스 서버 튜닝](#데이터베이스-서버-튜닝)
  - [SQL 튜닝](#sql-튜닝)
- [2.Altibase 서버 튜닝](#2altibase-서버-튜닝)
  - [로그파일](#로그파일)
  - [체크포인트](#체크포인트)
  - [버퍼](#버퍼)
  - [서비스 쓰레드](#서비스-쓰레드)
  ...
  - [CPU 사용률](#cpu-사용률)
- [3.쿼리 옵티마이저](#3쿼리-옵티마이저)
  - [쿼리 옵티마이저 개요](#쿼리-옵티마이저-개요)
  - [쿼리 변환](#쿼리-변환)
  - [논리적 실행 계획 생성](#논리적-실행-계획-생성)
  - [물리적 실행 계획 생성](#물리적-실행-계획-생성)
  - [옵티마이저 관련 프로퍼티](#옵티마이저-관련-프로퍼티)
- [4.EXPLAIN PLAN 사용하기](#4explain-plan-사용하기)
  - [EXPLAIN PLAN의 개요](#explain-plan의-개요)
  - [Plan Tree 출력](#plan-tree-출력)
  - [Plan Tree 읽기](#plan-tree-읽기)
  - [Plan Tree 활용](#plan-tree-활용)
  - [실행 노드](#실행-노드)
- [5.옵티마이저와 통계정보](#5옵티마이저와-통계정보)
  - [통계정보의 개요](#%통계정보의-개요)
  - [통계정보 관리](#통계정보-관리)
  - [자동 통계정보 수집(Auto Stats)](#자동-통계정보-수집auto-stats)
- [6.SQL 힌트](#6sql-힌트)
  - [힌트의 개요](#힌트의-개요)
  - [힌트의 종류](#힌트의-종류)
- [7.SQL Plan Cache](#7sql-plan-cache)
  - [SQL Plan Cache의 개요](#sql-plan-cache의-개요)
  - [SQL Plan Cache 관리](#sql-plan-cache-관리)
  - [Result Cache의 개요](#result-cache의-개요)
...
위의 조건에서 i1과 i2 칼럼에 각각 인덱스가 존재한다면 어떠한 인덱스를 선택할 것인가를 결정할 때 가장 중요한 요소는 해당 조건의 선택도이다. 예를 들어, i1 칼럼에 서로 다른 값의 종류가 100 [V(i1) = 100] 개가 있고, i2 칼럼에는 서로 다른 값의 종류가 1000 [V(i2) = 1000] 이라면 각 조건의 선택도는 다음과 같이 계산된다.
...
PARTITION-COORDINATOR 노드는 파티션드 테이블의 각각의 파티션에 대한 스캔을 관리하는 노드이다. 여러 개의 자식 노드를 가지며, 파티션 필터링을 수행한다.
