- [General Reference](#general-reference)
  - [3.데이터 딕셔너리](#3%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%94%95%EC%85%94%EB%84%88%EB%A6%AC)
    ...
    - [V\$QUEUE_DELETE_OFF](#v%5Cqueue_delete_off)
    ...
    - [V\$REPL_REMOTE_META_REPLICATIONS](#v%5Crepl_remote_meta_replications)
    - [V\$REPL_REMOTE_META_ITEMS](#v%5Crepl_remote_meta_items)
    - [V\$REPL_REMOTE_META_COLUMNS](#v%5Crepl_remote_meta_columns)
    - [V\$REPL_REMOTE_META_INDEX_COLUMNS](#v%5Crepl_remote_meta_index_columns)
    - [V\$REPL_REMOTE_META_INDICES](#v%5Crepl_remote_meta_indices)
    - [V\$REPL_REMOTE_META_CHECKS](#v%5Crepl_remote_meta_checks)
...
Standby 서버에서는 현재 데이터베이스에 적용중인 로그 레코드의 식별 번호가
표시된다.
...
Standby 서버에서는 현재 Active 서버의 CURRENT_SN과 해당 Standby 서버의
SYNCED_SN의 차이가 표시된다.
...
현재 서버의 동작 상태를 나타낸다. run, stop, 또는 Failure Server Repair로
표시된다.
