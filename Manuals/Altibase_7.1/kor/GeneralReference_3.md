...
- [General Reference](#general-reference)
  - [3.데이터 딕셔너리](#3%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%94%95%EC%85%94%EB%84%88%EB%A6%AC)
    ...
    - [SYS_REPL_TABLE_OID_IN_USE_](#sys_repl_table_oid_in_use%5C_)
    ...
    - [SYS_GEOMETRIES_](#sys_geometries%5C_)
    - [SYS_GEOMETRY_COLUMNS_](#sys_geometry_columns%5C_)
    - [USER_SRS_](#user_srs%5C_)
