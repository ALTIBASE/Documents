...
| Data Options: Batch LOB type                                 | Specifies whether to batch process BLOB and CLOB data types. If the data size is large, problems such as out-of-memory may occur, and some DBMS vendors, such as TimesTen, do not support it, so it should be used with caution. |
