...
| Keep Partition Table                         | Specifies whether or not to maintain partitioned tables.<br />When this option is set to 'Yes', partitioned tables in the the source database will be migrated as partitioned tables. In this case, additional work is required for the partitioned tables in reconcile stage. When this option is set to 'No', target partitioned tables will be migrated as non-partitioned tables. This option is set to 'No' by default. |
...
| Data Sampling                                | Specifies whether or not to use data sampling feature.<br />When this option is enabled, to decrease the data validation time, only sample data will be validated. When this option is disabled, every data will be validated. This option is set to 'Yes' by default. |
...
| **Object Options**           |                                                              |
| Foreign Key Migration        | Specifies whether or not to include foreign key constraints in migration target. This option is set to 'Yes' by default. |
