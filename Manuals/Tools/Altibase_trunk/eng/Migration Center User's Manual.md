...
- SQL Data Definition Language (DDL) script: An DDL SQL file to create database objects collected from source database in the project folder for user reference. However, it is not used in any step.
...
| Procedure                       | Partly yes                 | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| Function                        | Partly yes                 | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| View                            | Partly yes                 | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| Trigger                         | Partly yes                 | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
...
| Procedure              | X                          | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| Function               | X                          | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| View                   | X                          | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
| Trigger                | X                          | X                           | The original DDL collected is recorded in the SrcDbObj_Create.sql and BuildReport4Unsupported.html files. |
