...
- [Fixed Bugs](#fixed-bugs)
  - [BUG-49607 객체의 변경으로 PACKAGE SPEC 또는 TYPESET이 INVALID 상태로 변경되면, 이를 참조하는 객체도 INVALID 상태로 변경합니다.](#bug-49607객체의-변경으로-package-spec-또는-typeset이-invalid-상태로-변경되면-이를-참조하는-객체도-invalid-상태로-변경합니다)
