...
- [Fixed Bugs](#fixed-bugs)
  ...
  - [BUG-49767 REGEXP\_LIKE 함수에서 정규 표현식에 한글 사용 시 ERR-2105A : The pattern contains an invalid range. 에러가 발생합니다. 한글 검색 지원을 위해 PCRE2 라이브러리을 사용한 정규식 처리 방식을 추가합니다.](#bug-49767regexp_like-함수에서-정규-표현식에-한글-사용-시-err-2105a--the-pattern-contains-an-invalid-range-에러가-발생합니다-한글-검색-지원을-위해-pcre2-라이브러리을-사용한-정규-표현식-방식을-추가합니다)
  - [Changes](#changes)
