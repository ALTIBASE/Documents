...
### BUG-52244<a name=bug-52244></a> Fixed Unnecessary Lock Acquisition on META TABLEs During Statistics Collection After Server Restart

-   **module** : sm
-   **Category** : Functional Error
-   **Reproducibility** : Always
-   **Description** : Fixed an issue where locks were unnecessarily acquired on META TABLEs during the statistics collection process after server startup. Since META TABLEs do not require lock acquisition, the process has been improved to skip lock acquisition for META TABLEs.
