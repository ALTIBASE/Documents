...
This section introduces the DBMSs and versions that can be migrated using Migration Center 7.18.
...
This section summarizes new features, fixed bugs, and changes in Migration Center 7.18.
...
- MigrationCenter7.18.zip

- MigrationCenter7.18.tar.gz
