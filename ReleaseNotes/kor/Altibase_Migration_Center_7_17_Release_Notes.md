...
### BUG-51780 Migration Center에서 제공하는 매뉴얼 링크를 GitHub에서 매뉴얼 웹사이트로 변경해야 합니다.
Altibase 매뉴얼 웹사이트가 출시됨에 따라 Migration Center에서 제공하는 매뉴얼 링크를 기존 GitHub 링크에서 매뉴얼 웹사이트로 변경하였다.
